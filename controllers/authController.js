...
exports.updateProfile = async (req, res) => {
  ...
  try {
    ...
    if (req.file) {
      ...
      const uploadResult = await cloudinary.uploader.upload(req.file.path || `data:${req.file.mimetype};base64,${req.file.buffer.toString('base64')}`, {
        folder: 'profile_pics', 
        resource_type: 'image',
    ...
    if (error.http_code) {
      console.error('Cloudinary Error Details:', error.message, error.http_code);
    }
